...
echo off
disp('Push any key to begin the identification routine');  
tic
echo on
...
[t1,~,y1] = sim('loopshape',tfinal,[],u1);        
[t2,~,y2] = sim('loopshape',tfinal,[],u2);
toc
echo on
% Se presentan gráficos de las respuestas
echo off
disp('Push any key to begin the plotting section');  
figure
grid on
plot(t1,y1(:,1))
...
xlabel('t')
ylabel('Magnitud')
disp(' d: push any key to continue');  
figure
plot(t2,y2(:,1))
grid on
